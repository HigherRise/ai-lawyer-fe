...
const questions = [
  {
    id: 1,
    name: "Straightforward Cases",
    description: "Minimal disputes or conflicts of interest.",
    difficulty: "Easy",
  },
  {
    id: 2,
...
const interviewers = [
  {
    id: "John",
    name: "John",
    description: "Business Legal Compliance Lawyer",
    level: "L3",
  },
  {
    id: "Richard",
  ...
  },
  {
    id: "Sarah",
    name: "Sarah",
    description: "Straightforward Cases",
    level: "L7",
  },
];
              ...
              >
                <ul className="mb-auto list-none">
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">Court Case Vault</p>
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">My Court Cases</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
                  ...
                  <div>
                    ...
                    >
                      {selected.name === "Straightforward Cases"
                        ...
                        : selectedInterviewer.name === "Richard"
                        ? "According to the case 1029 / 19 a similar case in UK on 12th Jan 1919?"
